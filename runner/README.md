...
```
python src/train.py experiment=cfm model=cfm launcher=mila_cpu_cluster datamodule=moons seed=42 model.sigma_min=0.1 model.plot=true model.gaussian_sampler=QMC
```
